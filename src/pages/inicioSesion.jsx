...
const Login = () => {
  ...
  return (
    <div className="font-principal w-screen flex justify-center items-center h-screen">
      {isLoading ? (
        <LoadingBar /> // Barra de carga durante la solicitud
      ) : (
        <>
            ...
            <div className="w-[80%] mx-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label
                    htmlFor="password"
                    className="block text-gray-700 pb-5"
                  >
                    Contraseña
                  </label>
              ...
              <div className="flex justify-end py-2 my-5">
                <Link
                  to="/registro"
                ...
                >
                  ...
                  <span className="font-bold pl-5 text-red-700">
                    Regístrate
                  </span>
                </Link>
              </div>
