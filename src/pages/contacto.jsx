        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="text-center text-white">
              ...
              <p className="text-1xl mx-9 font-bold mb-4 md:text-2xl">
                {slide.subtitle}
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <form className="grid gap-4 p-6 bg-white rounded-xl shadow-md area md:area-md">
              <input
                type="text"
                placeholder="NOMBRE"
                className="p-3 border border-gray-300 bg-[#eff1f2] rounded-md [grid-area:nombre]"
              />
              <input
                type="email"
                placeholder="CORREO"
                className="p-3 border border-gray-300 rounded-md bg-[#eff1f2] w-full [grid-area:correo]"
              />
              <input
                type="text"
                placeholder="CELULAR"
                className="p-3 border border-gray-300 rounded-md bg-[#eff1f2] w-full [grid-area:celular]"
              />
              <textarea
                placeholder="MENSAJE"
                className="p-3 border border-gray-300 rounded-md bg-[#eff1f2] w-full h-32 [grid-area:mensaje]"
              ></textarea>
              <button
                type="submit"
                className="bg-red-600 text-white font-semibold py-2 rounded-md hover:bg-red-700 [grid-area:enviar]"
              >
                ENVIAR
              </button>
            </form>
            ...
            <div className="w-[70%] flex items-center justify-center text-center md:text-left md:order-3 mx-auto">
              <div>
                ...
                <p className="mt-4 text-gray-600">
                  ...
                  />
                  <a
                    href="https://www.facebook.com/corredorrojope"
                    target="_blank"
                ...
                <p className="mt-4 text-gray-600">
                  ...
                  />
                  <a
                    href="https://x.com/corredor_rojo?lang=es"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Twitter
                ...
                <p className="mt-4 text-gray-600">
                  ...
                  />
                  <a
                    href="https://www.instagram.com/corredorrojo_pe/?hl=es-la"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Instagram
